 ...
 * generated in the com.san.test.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _C2F_QNAME = new QName("http://test.san.com/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://test.san.com/", "f2cResponse");
    private final static QName _C2FResponse_QNAME = new QName("http://test.san.com/", "c2fResponse");
    private final static QName _F2C_QNAME = new QName("http://test.san.com/", "f2c");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.san.test.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.san.com/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.san.com/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.san.com/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.san.com/", name = "f2c")
