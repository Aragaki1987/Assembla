 ...
 * generated in the com.san.beans package. 
...
public class ObjectFactory {
    ...
    private final static QName _ReverseStringReq_QNAME = new QName("http://www.san.com/stringprocessor", "reverseStringReq");
    private final static QName _ReverseStringResp_QNAME = new QName("http://www.san.com/stringprocessor", "reverseStringResp");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.san.beans
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.san.com/stringprocessor", name = "reverseStringReq")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.san.com/stringprocessor", name = "reverseStringResp")
